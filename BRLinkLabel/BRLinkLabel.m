...
{
    NSAttributedString * attString = [[NSAttributedString alloc] initWithString:self.textString attributes:@{NSLinkAttributeName: self.linkString, NSFontAttributeName: [NSFont systemFontOfSize:NSHeight(self.bounds) - 2*BRStringAlign], NSUnderlineStyleAttributeName:@(self.mouseIn), NSForegroundColorAttributeName:self.textColor}];
